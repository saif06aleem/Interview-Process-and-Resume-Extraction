...
class QuizApp:
    def __init__(self, root):
        ...
        self.emotion_model = load_model("C:/Users/USER/Desktop/Project4U-Intern/Interview_project/my_model.zip")
    ...
    def _record_audio(self, duration):
        ...
        save_directory = "C:/Users/USER/Desktop/Project4U-Intern/Interview_project"
    ...
    def convert_audio_to_text(self, audio_file):
        ...
        try:
            ...
            filename_answer = os.path.join(r'C:/Users/USER/Desktop/Project4U-Intern/Interview_project',
    ...
    def save_result_to_csv(self, result_text):
        csv_filename = os.path.join("C:/Users/USER/Desktop/Project4U-Intern/Interview_project", "results.csv")
